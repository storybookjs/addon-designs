...
[Example](/?path=/story/docs-image-examples--embed-image)
...
[Example](/?path=/story/docs-image-examples--embed-image-with-import)
...
[Example](/?path=/story/docs-image-examples--set-scale-and-offset)
